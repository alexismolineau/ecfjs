...
const Results = props => {
    ...
    //méthode pour afficher la modal ou non avec ses datas
    ...
    return(
        <div className="container">
            <span className="badge bg-secondary mb-3">Résultats: {props.jquery ? "blah" : props.searchResults.count ? props.searchResults.count : 0}</span>
